...
INSERT INTO `customer` VALUES (38,'panupong','prueksa','Bangkok','0838479383','panupong_pruk@hotmail.com'),(39,'Chayanis','Tunterapong','ladkrabang bangkok','0831155255','s5070020@kmitl.ac.th');
...
INSERT INTO `employee` VALUES ('55070071','Pavarisa','Chuenchuphol','F','blah blah',12000,'0835177264','s5070071@kmitl.ac.th','55070071'),('55070089','Panupong','Prueksa','M','17/3 Bangkok',NULL,'0838479383','panupong_pruk@hotmail.com','55070089');
...
CREATE TABLE `order` (
  ...
  KEY `fk_emp1_idx` (`employee_emp_id`),
  CONSTRAINT `fk_emp1` FOREIGN KEY (`employee_emp_id`) REFERENCES `employee` (`emp_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `payment` (
  ...
  KEY `fk_order_pay_idx` (`pay_id`),
  CONSTRAINT `fk_order_pay` FOREIGN KEY (`pay_id`) REFERENCES `order` (`order_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `table` VALUES (1,6,'outdoor','no'),(2,4,'outdoor','no'),(3,4,'outdoor','no'),(4,4,'outdoor','no'),(5,4,'outdoor','no'),(6,4,'outdoor','no'),(7,4,'outdoor','no'),(8,4,'outdoor','no'),(9,4,'outdoor','no'),(10,4,'outdoor','no'),(11,4,'outdoor','no'),(12,4,'outdoor','no'),(13,4,'outdoor','no'),(14,4,'outdoor','no'),(15,5,'outdoor','no'),(16,5,'outdoor','no'),(17,5,'outdoor','no'),(18,4,'outdoor','no'),(19,4,'outdoor','no'),(20,4,'outdoor','no'),(21,4,'outdoor','no'),(22,4,'outdoor','no'),(23,4,'classic','no'),(24,4,'classic','no'),(25,4,'classic','no'),(26,4,'classic','no'),(27,4,'classic','no'),(28,4,'classic','no'),(29,4,'classic','no'),(30,4,'classic','no'),(31,8,'modern','no'),(32,8,'modern','no'),(33,6,'modern','no'),(34,6,'modern','no'),(35,4,'modern','no'),(36,4,'modern','no'),(37,4,'modern','no'),(38,4,'modern','no'),(39,4,'modern','no'),(40,4,'modern','no'),(41,4,'modern','no'),(42,4,'modern','no'),(43,4,'modern','no');
...
INSERT INTO `username` VALUES ('nunan','55070020','2014-03-12 18:04:36','C',NULL,39),('phai','windows764bits','2014-03-12 17:14:25','A',55070089,NULL),('primetogo','windows764bits','2014-03-12 17:08:12','C',NULL,38),('sand','55070071','2014-03-12 17:08:12','A',55070071,NULL);
...
-- Dump completed on 2014-03-13  1:07:20
